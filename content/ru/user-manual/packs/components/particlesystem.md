...
| Color Map       | Текстура цветовой карты, которую нужно применить ко всем частицам в системе. Если текстурный актив не назначен, используется текстура-заплатка по умолчанию. |
