...
Чтобы исправить предупреждение, выберите актив модели и откройте раздел **Pipeline**. Нажмите кнопку **Auto-Unwrap** и дождитесь завершения индикатора выполнения. Автоматическое развертывание изменит актив модели, поэтому если вы повторно импортируете модель из источника (например, загрузите новый FBX), предварительно рассчитанный UV1 будет потерян. Если загруженная модель не имеет UV1, вам нужно будет снова выполнить автоматическое развертывание модели.
