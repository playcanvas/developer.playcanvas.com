...
Рекламные объявления ironSource используют стандарт [MRAID 2.0 API][mraid-api] и требуют, чтобы активы для объявления были внешними относительно `index.html`, а не встроенными.

Внешние активы необходимо будет загрузить на свой сервер или CDN, чтобы ironSource мог разместить объявление в своей сети.
