...
<table class="table table-striped">
    ...
    <tr>
        <td>Exit Time</td>
        <td>If provided, this transition will only be active for the exact frame during which the source states progress passes the time specified. Given as a normalised value of the source states duration. Values less than 1 will be checked every animation loop.</td>
    </tr>
    <tr>
        <td>Offset</td>
