...
Also notice the different color of the label of the the field that has been overriden. You can also see a more detailed list of all the overrides by clicking View Diff. See [Overrides Diff View][4] for more information.
...
To apply an override you can click APPLY in the tooltip shown when you hover over the overriden field. 
