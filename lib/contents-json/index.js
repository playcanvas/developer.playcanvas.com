...
module.exports = function makePlugin(dir) {
    ...
    return function (opts) {
        return function (files, metalsmith, done) {
            ...
            var shaderEditorContents = {};

            var extactIndex = function (manual) {
                var result = [];
            ...
            langs.forEach(function (lang) {
                ...
                usermanualContents[lang] = extactIndex(json[lang]['user-manual']);
                ...
                // shader editor
                shaderEditorContents[lang] = extactIndex(json[lang]['shader-editor']);
