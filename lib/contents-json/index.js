    ...
    return function (opts) {
        return function (files, metalsmith, done) {
            ...
            langs.forEach(function (lang) {
                ...
                var content = json[lang]['tutorials'];
                for (var key in content) {
                    ...
                    if (o.path.indexOf("beginner") >= 0) {
                        tutorialContents[lang].beginner.push(o);
                    }
                    if (o.path.indexOf("intermediate") >= 0) {
                        tutorialContents[lang].intermediate.push(o);
                    }
                    if (o.path.indexOf("advanced") >= 0) {
                        tutorialContents[lang].advanced.push(o);
                    }
